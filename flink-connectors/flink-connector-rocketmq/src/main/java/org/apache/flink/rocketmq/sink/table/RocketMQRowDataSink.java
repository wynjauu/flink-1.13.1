...
public class RocketMQRowDataSink extends RichSinkFunction<RowData> {
    ...
    private RocketMQSerializationSchema rocketMQSerializationSchema;

    public RocketMQRowDataSink(
            RocketMQSink sink,
            RocketMQRowDataConverter converter,
            RocketMQSerializationSchema rocketMQSerializationSchema) {
        this.sink = sink;
        this.converter = converter;
        this.rocketMQSerializationSchema = rocketMQSerializationSchema;
    }
    ...
    public void invoke(RowData rowData, Context context) throws Exception {
        ...
        Message message = rocketMQSerializationSchema.serialize(rowData);
        if (message != null) {
